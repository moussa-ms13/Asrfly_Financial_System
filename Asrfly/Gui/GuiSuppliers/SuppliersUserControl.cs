    ...
    public partial class SuppliersUserControl : UserControl
    {
        ...
        public async void LoadData()
        {
            ...
            if (dataGridView1.Columns.Count == 0)
            {
                ...
                AddColumn("Name", "الاسم", "Name");
                AddColumn("PhoneNumber", "رقم الهاتف", "PhoneNumber");
                AddColumn("Address", "العنوان", "Address");
                AddColumn("Email", "البريد الإلكتروني", "Email");
                AddColumn("Details", "التفاصيل", "Details");
                AddColumn("Balance", "الرصيد", "Balance");
